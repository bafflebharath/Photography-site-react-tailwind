...
import { SelectedPage, SelectedCategory } from "@/shared/types";
...
const Gallery = ({ setSelectedPage }: Props) => {
    ...
    return (
        <section id="gallery" className="mx-auto w-5/6 pt-20 pb-32">
            <motion.div
                onViewportEnter={() => setSelectedPage(SelectedPage.Gallery)}
            ></motion.div>
            <div className='max-w-[1000px] w-full m-auto relative group'>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:px-0 ">
