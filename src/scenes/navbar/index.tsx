  ...
  return (
    <nav>
      ...
      {!isAboveMediumScreens && (
              <button className="rounded-full bg-red-500 ml-2 p-1" onClick={() => setIsMenuToggled(!isMenuToggled)}>
      ...
      {!isAboveMediumScreens && isMenuToggled && (
        <div className="fixed left-0 bottom-0 z-40 h-full w-[300px] bg-gray-300 drop-shadow-xl">
          {/* CLOSE ICON */}
