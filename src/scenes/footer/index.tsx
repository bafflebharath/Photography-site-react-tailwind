const Footer = () => {
    ...
    return (
        <footer>
            <div className="justify-content mx-auto w-5/6 gap-16 md:flex pt-20">
                ...
                <div className="mt-16 basis-1/4 md:mt-0">
                    ...
                    <p className="my-5 flex items-center cursor-pointer" onClick={openMailComposeBox}>
                        ...
                        <span className="text-sm font-bold">vinithudhaya.m@gmail.com</span>
                    </p>
                    <p className="my-5 flex items-center cursor-pointer" onClick={openInstagramPage}>
                        ...
                        <span className="text-sm font-bold">blackboxstudios.insta</span>
                    </p>
                    <p className="my-5 flex items-center cursor-pointer" onClick={openFacebookPage}>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-5 w-5 mr-2"
                            fill="currentColor"
                        ...
                        <span className="text-sm font-bold">blackboxstudios.fb</span>
                    </p>
                </div>
                <div className="mt-16 basis-1/4 md:mt-0">
                    ...
                    <p className="my-5 flex items-center cursor-pointer" onClick={openDialPad}>
                        ...
                        <span className="text-sm font-bold">+91 8695718686</span>
                    </p>
