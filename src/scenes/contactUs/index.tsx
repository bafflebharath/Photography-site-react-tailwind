...
const ContactUs = ({ setSelectedPage }: Props) => {
    return (
        <section id="contactus" className="pt-28 w-full h-screen relative group pr-5 pl-5 justify-center items-center">
            <motion.div
            ...
            >
                ...
                <div className="text-white text-center mb-24">
                    ...
                    <div className="mt-16 basis-1/3 md:mt-0">
                        <p className="my-5 flex justify-center items-center cursor-pointer" onClick={openDialPad}>
                            <span>
                        ...
                        <p className="my-5 flex justify-center items-center cursor-pointer" onClick={openInstagramPage}>
                            <svg
                        ...
                        <p className="my-5 flex justify-center items-center cursor-pointer" onClick={openWhatsApp}>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                className="h-5 w-5 mr-2"
                                fill="currentColor"
                        ...
                        <p className="my-5 flex justify-center items-center cursor-pointer" onClick={openMailComposeBox}>
                            <svg
                                className="h-5 w-5 mr-2"
